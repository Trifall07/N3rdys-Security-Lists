...
echo.
echo 12. Disable Unneeded Windows Features
echo.
echo 13. Exit
echo.
echo.
...
if %option%== 12 goto :WindowsFeatures
if %option%== 13 exit
goto :Options
...
@echo 9)  Ports blocked : 20(FTP),21(FTP),23(TelNet),25(SMTP),135(RPC),161(SNMP),389(LDAP),411(PTP),412(PTP),520(RIP),1080(SOCKS),1900(SSDP). >> %logpath%
